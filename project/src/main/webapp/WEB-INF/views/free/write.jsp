...
<!-- 입력 -->
	<div class="form-group">
		...
		<input type="text" class="form-control" id="board_sub" name="free_sub" style="width:613px;">
		<input type="hidden" id="client_nick1" name="client_nick1" value="${sessionScope.check.client_nick1}">
	</div>
	<div><p></p>
		&nbsp; <textarea class="form-control" id="board_content" name="free_content" style="width:650px; height:300px;"></textarea>
	</div>
	<p></p>
<!-- file upload -->
	<div class="upload">
