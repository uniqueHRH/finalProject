...
public class ClientVo {
	...
	public ClientVo(String client_nick1, String client_nick2, String client_name, String client_phone,
	...
	public String toString() {
		return "ClientVo [client_nick1=" + client_nick1 + ", client_nick2=" + client_nick2 + ", client_name="
				+ client_name + ", client_phone=" + client_phone + ", client_sex=" + client_sex + ", client_birth="
				+ client_birth + ", client_id=" + client_id + ", client_pw=" + client_pw + ", client_email="
				+ client_email + ", client_joindate=" + client_joindate + ", client_level=" + client_level
